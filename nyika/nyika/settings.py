# Django settings for nyika project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a nyika directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'nyika')
...
SECRET_KEY = 'pt(^#43!=h*1vj_s%xl5n6s99kjq%&ay*ogy$bvxwhwmts!@8t'
...
ROOT_URLCONF = 'nyika.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'nyika.wsgi.application'
...
#    'nreg.register_handler.KeywordHandler'
    'nreg.register_handler.RegisterHandler',
